  ...
  vm1 = {
    ...
    source = {
      script = <<-EOT
        ...
        Start-Process powershell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -Command Add-Content -Path "C:\\inetpub\\wwwroot\\iisstart.htm" -Value $("Hello World from " + $env:computername)' -Wait
      EOT
    }
  }
}
